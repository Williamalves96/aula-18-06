...
const campoTitulo = document.getElementById("namebook");
const campoAutor = document.getElementById("autorBook");
...
function cadastroLivro(){
        ...
        let autor = campoTitulo.value;
        let genero = campoTitulo.value;
        let isbn = campoTitulo.value;
        let mensagem = "Cadastro Efetuado!";
        alert(mensagem);
